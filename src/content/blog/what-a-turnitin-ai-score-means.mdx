...
faqs:
  - q: "Does 40% AI mean 40% of my essay was written by AI?"
    a: "No. It means roughly 40% of the sentences the system assessed fell on the AI side of its classifier's boundary. It is not a measure of confidence, and not all of a document is assessed."
  - q: "Why is the AI score different from the similarity score?"
    a: "The similarity score compares your text against real documents and can show you the match. The AI indicator compares nothing - it is a statistical estimate about the text itself, with no source to check."
  - q: "Why does careful, well-edited writing get flagged?"
    a: "Detectors measure predictability. Clear, conventional, grammatically tidy prose using common vocabulary is statistically similar to generated text, so proofreading can raise your score rather than lower it."
  - q: "Is Turnitin's AI detection accurate?"
    a: "Accuracy varies widely with document length, writing style, and the writer's first language. Published research found detectors misclassify non-native English writing at dramatically higher rates, and Turnitin itself acknowledges false positives."
