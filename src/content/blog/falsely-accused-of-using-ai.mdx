...
date: "2026-08-18"
category: "detection"
answer: "If you are wrongly accused of using AI, stop editing the document immediately and export its version history - that record of the writing happening over time is the strongest evidence most people have. Then find your institution's policy and its appeal deadline, respond calmly with your evidence first, and offer to discuss the work in person. Raise the detector's unreliability last, not first, because leading with it reads as deflection."
faqs:
  - q: "Can an AI detector prove I cheated?"
    a: "No. AI detectors estimate how statistically predictable text is; they do not detect authorship and cannot point to a source document the way a plagiarism checker can. Turnitin's own guidance says its AI indicator should not be the sole basis for a misconduct finding."
  - q: "What evidence proves I wrote something myself?"
    a: "Version history from Google Docs or Microsoft 365 is the strongest, because it shows composition over time. Dated notes, earlier drafts, research history, and messages where you shared a paragraph all help. Being able to discuss your own argument in detail is often what ends the case."
  - q: "Should I rewrite my work to lower the AI score?"
    a: "No. Changing the text after an accusation is indefensible, and if the version you defend differs from the one you submitted you have created a worse problem. Rewriting tools are for improving a draft before submission, not for altering flagged work."
  - q: "How long do I have to appeal?"
    a: "Appeal windows are usually short, often between five and fifteen working days, and are strictly enforced. Find the deadline in your institution's written policy before you draft any response."
