...
description: "Detectors measure vocabulary predictability, and non-native writing is predictable for innocent reasons. The mechanism, the evidence, and what to do."
date: "2026-08-14"
category: "detection"
answer: "AI detectors flag second-language English writing at far higher rates because they measure vocabulary predictability, and writing in a second language is predictable for innocent reasons: a smaller active vocabulary means safer, higher-frequency word choices, and formal instruction teaches the same connective structures models overproduce. Research published in Patterns in 2023 found the effect largely disappeared when the same essays were rewritten with more varied vocabulary."
faqs:
  - q: "Are AI detectors biased against ESL students?"
    a: "Effectively yes. A 2023 study in Patterns found GPT detectors misclassified essays by non-native English writers at dramatically higher rates than native writers', and that rewriting the same essays with richer vocabulary removed most of the effect."
  - q: "Why does my English get flagged as AI?"
    a: "Because you likely use vocabulary you are confident is correct, which tends to be the most common word available, exactly what a language model would predict. Careful word choice lowers perplexity, which detectors read as machine-like."
  - q: "Should I write worse to avoid being flagged?"
    a: "No. That degrades your writing and teaches the wrong lesson. Genuinely building vocabulary range and varying sentence length improves your writing and raises perplexity as a side effect."
  - q: "What should I say if I am accused?"
    a: "Explain the mechanism, not just your innocence: detectors score predictability, and second-language writing is predictable for reasons unrelated to tool use. Cite the Patterns research, and show notes or outlines written in your first language."
